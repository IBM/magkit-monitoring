...
Make sure your patches are well tested. Ideally create a topic branch for every change you make.
For example:
...
| 1.3.0 | 17   | 6.4.2    | 1.2.0       | 1.16.0     |

Add this dependency to your Magnolia installation
```xml
<dependency>
...
```
If you need an older version, then use version 1.1.1
```xml
<dependency>
...
The Prometheus Endpoint exposes time series data concerning different aspects of the application. This data is exposed by several metrics in a simple text-based format specific for prometheus.
...
<table>
    ...
    <tr>
        <td valign="top"><code>magnolia.monitoring.prometheus.metrics</code></td>
        <td>
            <p>
            ...
            <p>By default, the following collectors are active: <code>Uptime,Processor,JvmThread,JvmGc,JvmMemory,ClassLoader,Log4J2</code></p>
            <p>See <b>Collectors</b> for a list of exposed metrics by the collectors.</p>
            <p><b>Example</b></p>
            <code>magnolia.monitoring.prometheus.metrics=Uptime,Processor,JvmInfo,Log4j2</code>
        </td>
    </tr>
    <tr>
        <td valign="top"><code>magnolia.monitoring.prometheus.http.uris</code></td>
        <td>
          ...
          <p><b>Example:</b></p>
          <code>magnolia.monitoring.prometheus.http.uris=/author/.magnolia/.*,/.rest/custom-endpoint</code>
        </td>
    </tr>
    <tr>
        <td valign="top"><code>magnolia.monitoring.prometheus.http.slo</code></td>
        <td>
          <p>
          ...
          <p><b>Example:</b></p>
          <code>magnolia.monitoring.prometheus.http.slo=100,1000,5000</code>
        </td>
   </tr>
</table>
